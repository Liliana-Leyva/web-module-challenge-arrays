...
function getFlavorByIndex(arreglo,index){ // Function with 2 arguments

return arreglo[index];

}

getFlavorByIndex(originalFlavors,2); //calling the function and passing the name of the array and the index
...
console.log("This is a copy of the original array",(copy(originalFlavors, 'newArray')));
